...
This project is indexed by GitNexus as **lacp** (263 symbols, 465 relationships, 15 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
